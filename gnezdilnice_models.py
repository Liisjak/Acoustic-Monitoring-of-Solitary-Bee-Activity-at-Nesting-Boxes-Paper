...
class ResNet9_myrtle(nn.Module):
    def __init__(self, in_channels, num_classes):
        ...
        self.linear = nn.Linear(8192, num_classes) # for 128x128
        #self.dimreduc = nn.Linear(512, 32)
    ...
    def forward(self, out):
            ...
            #out = self.dimreduc(out)
            #print('Dim reduc:', out.shape)
...
def ResNet9(num_classes=2):
    return ResNet9_myrtle(in_channels = 1, num_classes=num_classes)
...
def conv3x3(in_planes, out_planes, stride=1):
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False) # output image size: (W-F+2P)/S + 1; W initial image size, F filter size, P padding, S stride
